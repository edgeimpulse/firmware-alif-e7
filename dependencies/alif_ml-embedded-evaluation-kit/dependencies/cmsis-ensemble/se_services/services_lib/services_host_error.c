  ...
  switch (error_code)
   {
       ...
       case SERVICES_REQ_BAD_PRINT_LENGTH:
         p_str = "SERVICES_REQ_BAD_PRINT_LENGTH       "; break;
       case SERVICES_REQ_NULL_PARAMETER:
         p_str = "SERVICES_REQ_NULL_PARAMETER         "; break;
       case SERVICES_REQ_PIN_LOCKED:
         p_str = "SERVICES_REQ_PIN_LOCKED             "; break;
       case SERVICES_REQ_COMMAND_NOT_IMPLEMENTED:
         p_str = "SERVICES_REQ_COMMAND_NOT_IMPLEMENTED"; break;
       case SERVICES_REQ_INVALID_OTP_OFFSET:
         p_str = "SERVICES_REQ_INVALID_OTP_OFFSET     "; break;
       default:
