...
#ifndef _ETH_DW_EQOS_H_
#define _ETH_DW_EQOS_H_
...
/** \brief Representation of EQOS MAC device. */
typedef struct {
  volatile DW_EQOS_REGS *regs;       /**< IOMEM base address of the Ethernet MAC instance */
